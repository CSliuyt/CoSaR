...
class Logger:
    ...
    def info(self, content):
        ...
        timestamp = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
        print_to_console(f"{PStyle['green']}{timestamp}{PStyle['end']} - | {PStyle['blue']}INFO{PStyle['end']}     | "
                         f"- {PStyle['blue']}{content}{PStyle['end']}")

    def msg(self, content):
        timestamp = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
        print_to_console(f"{PStyle['green']}{timestamp}{PStyle['end']} - | {PStyle['yellow']}MSG{PStyle['end']}    | "
                         f"- {PStyle['yellow']}{content}{PStyle['end']}")
